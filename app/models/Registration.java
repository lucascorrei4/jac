...
public class Registration extends Model {
	...
	public Date getPostedAt() {
		if (postedAt == null) {
			postedAt = Utils.getBrazilCalendar().getTime();
		}
		return postedAt;
	}
	...
	public boolean isTheVoice() {
		return theVoice;
	}

	public void setTheVoice(boolean theVoice) {
	...
	public String getRGOrgan() {
		return RGOrgan;
	}

	public void setRGOrgan(String rGOrgan) {
		RGOrgan = rGOrgan;
	}
